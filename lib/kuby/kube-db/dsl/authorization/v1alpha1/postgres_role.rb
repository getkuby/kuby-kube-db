module Kuby::KubeDB::DSL::Authorization::V1alpha1
  class PostgresRole < ::KubeDSL::DSLObject
    ...
    validates :status, object: { kind_of: Kuby::KubeDB::DSL::Authorization::V1alpha1::PostgresRoleStatus }
    validates :spec, object: { kind_of: Kuby::KubeDB::DSL::Authorization::V1alpha1::PostgresRoleSpec }
